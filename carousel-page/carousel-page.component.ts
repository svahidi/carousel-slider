...
export class CarouselPageComponent implements OnInit {
  ...
  @Input() thumbnailOverlap = false;
  @Input() showFullSizePreview = false;
  @Input() autoPlay = true;
  @Input() autoPlayTime = 5000;
  @Input() thumbnailType: 'circle' | 'square' | 'none' = 'circle';
  @Input() width: any = 40; // em size
  @Input() height: any = 25; // em size
  ...
  setAutoId() {
    ...
    this.width = this.width.toString() + 'em';
    this.height = this.height.toString() + 'em';
  }
